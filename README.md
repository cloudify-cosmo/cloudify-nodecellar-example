...
networking:
   ...
   subnet:
       ...
       dns_nameservers: []
   ext_network:
       create_if_missing: true #For now, this must be 'create_if_missing': False
       name: Ext-Net
   router:
       create_if_missing: true
...
```
cfy blueprints upload -b nodecellar blueprint.yaml
```
...
```
cfy deployments execute -d nodecellar install
```
...
```
2014-05-07T12:10:10 CFY <nodecellar2d1> [neutron_subnet_1100c] Creating node
```
...
```
cfy deployments execute -d nodecellar uninstall
```
